    ...
    <div class="testquestions">
        ...
        <div class="questionsContent">
            <swiper ref="mySwiper" :options="swiperOption">
                <swiper-slide v-for="(item,index) in testQuestions" :key="index" v-if="pageShow">
...
<script>
    ...
    import PopupPic from '../../../components/teacherClassroom/PopupPicIntest'
    import {mapGetters} from 'vuex'
    import store from '@/store'
    import StudentList from '../../../components/teacherClassroom/studentListIntest'
    import questionChart from '../../../components/teacherClassroom/chartIntest'
    ...
    export default {
        ...
        mounted() {
            this.swiper.slideTo(this.testInitSlide, 800, false);
            this.pageShow = true;
            this.loading = false;
            this.studentCount = this.testStudents.length;
            this.header.title = this.testName;
