                        ...
                        <div class="subjective_warp">
                            ...
                            <div class="subjective">
                                ...
                                <div class="topic_warp" :id="'qc'+item.questionId">
                                    <div class="title">主观题-{{index+1}} <span v-if="item.questionTypeInCN">({{item.questionTypeInCN}})</span><span v-if="item.questionPoint">({{item.questionPoint}}分)</span></div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                jump: {name: '转至客观题', url: '/TStudentObjective'},
        ...
        methods: {
            ...
            getSubjectiveWork() {
                ...
                for (let i = 0; i < this.homeworkSubjectiveQs.length; i++) {
                    this.subjectiveAnswer.push({id: this.homeworkSubjectiveQs[i].questionId, answerId: '', answer: '', show: false, score: ''})
                    this.cover_box[this.homeworkSubjectiveQs[i].questionId] = 0;
                }
